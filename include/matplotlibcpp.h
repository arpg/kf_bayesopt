...
namespace matplotlibcpp {
	...
	inline bool stem(const std::vector<double>& x, const std::vector<double>& y, const std::string& format = "")
	{
		return stem<double, double>(x, y, format);
	}

	inline bool stem(const std::vector<double>& y, const std::string& format = "")
	{
		return stem<double>(y, format);
	}

	inline bool stem(const std::vector<double>& x, const std::vector<double>& y, const std::map<std::string, std::string>& keywords)
	{
